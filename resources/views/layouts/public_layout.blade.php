...
<head>
    ...
    <meta name="keywords" content="ravenstone, castle, tours, bed and breakfast, hotel, rooms, Illinois, spa, wedding, party, tea, special occasion, ravenstone castle, vacation" />
    <meta name="csrf-token" content="{{csrf_token()}} "/>

    {{--<meta name="_token" content="{{ app('Illuminate\Encryption\Encrypter')->encrypt(csrf_token()) }}" />--}}
    <link rel="icon" type="image/png" href="{{asset('favicon.png')}}" sizes="32x32">
    <title>Ravenstone Castle</title>
    ...
    <nav class="navbar navbar-inverse " role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">Ravenstone Castle</a>
            </div>

            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active pages" id="home"><a href="/">Home</a></li>
                    <li><a class="pages" id="breakfast" href="#">Bed & Breakfast</a></li>
                    <li><a href="#" class="pages" id="parties">Private Parties</a></li>
                    <li><a href="#" class="pages" id="tours">Tours</a></li>
                    <li><a href="#" class="pages" id="events">Events</a></li>
...
<div class="container">
    <footer class="footer">
        <div class="container">
            <p class="text-muted text-center">Ravenstone Castle | All rights reserved &copy; | {{date('Y')}}</p>
        </div>
    </footer>
</div>
